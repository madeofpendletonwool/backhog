...
// heartbeat keeps a claim alive while the CPU is busy. Reading one page
// can take tens of seconds with nothing to report; without this the
// API's reclaim pass would eventually decide the worker had died and
// hand the comic to someone else mid-book.
...
// the pass instead of letting two workers write the same corpus.
